...
def _main():
    ...
    if is_tiny_version:
        print('Run Tiny Yolo')
        model,model_test = create_tiny_model(input_shape, anchors, num_classes,
    ...
    if True:
        ...
        batch_size = 9 # note that more GPU memory is required after unfreezing the body
        print('Train on {} samples, val on {} samples, with batch size {}.'.format(num_train, num_val, batch_size))
        model.fit_generator(data_generator_wrapper(lines[:num_train], batch_size, input_shape, anchors, num_classes),
            steps_per_epoch=max(1, num_train//batch_size),
            validation_data=data_generator_wrapper(lines[num_train:], batch_size, input_shape, anchors, num_classes),
...
def create_tiny_model(input_shape, anchors, num_classes, load_pretrained=True, freeze_body=2,
    ...
    model_body = tiny_yolo_body(image_input, num_anchors//1, num_classes)
...
def data_generator(annotation_lines, batch_size, input_shape, anchors, num_classes):
    ...
    while True:
        ...
        for b in range(batch_size):
            ...
            image, box = get_random_data(annotation_lines[i], input_shape, randomize=True)
